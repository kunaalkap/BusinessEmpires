  ...
  function init() {
    ...
    const CITIES = [
      { name: 'Surat',        x: -1.34, y: -0.04,
        ...
        wikiTitle: 'Surat',
        imgCaption: 'Surat — EIC\'s first Indian factory, est. 1608' },
      { name: 'Bombay',       x: -1.34, y: -0.34,
        ...
        wikiTitle: 'Bombay Presidency',
        imgCaption: 'Bombay — western HQ of the East India Company' },
      { name: 'Madras',       x: -0.30, y: -1.16,
        ...
        wikiTitle: 'Fort St. George, Chennai',
        imgCaption: 'Fort St George, Madras — first EIC fort in India' },
      { name: 'Calcutta',     x:  0.82, y:  0.15,
        ...
        wikiTitle: 'Fort William, Kolkata',
        imgCaption: 'Fort William, Calcutta — seat of EIC Bengal governance' },
      { name: 'Cochin',       x: -0.85, y: -1.59,
        ...
        wikiTitle: 'Fort Kochi',
        imgCaption: 'Fort Kochi — spice trade post on the Malabar Coast' },
      { name: 'Masulipatnam', x: -0.19, y: -0.73,
        ...
        wikiTitle: 'Machilipatnam',
        imgCaption: 'Machilipatnam — first EIC Coromandel factory, est. 1611' },
      { name: 'Patna',        x:  0.36, y:  0.56,
        ...
        wikiTitle: 'Patna',
        imgCaption: 'Patna — inland factory on the Ganges, est. 1620' },
    ];
